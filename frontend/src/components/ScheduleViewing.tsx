...
export const ScheduleViewing: React.FC = ( { listingId, landlordId } ) => {
    ...
    return (
        <Card style={styles.container}>
            ...
            <Text style={styles.timeText}>{date.toISOString().split('T')[0] + " " + date.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit', hour12: false})}</Text>
            <Button style={styles.button} onPress={() => setDatePickerVisibility(true)}><Text style={styles.buttonText}>Choose time for Viewing</Text></Button>
