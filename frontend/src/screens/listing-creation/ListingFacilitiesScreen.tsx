...
type ListingFacilitiesScreenPops = {
	route: RouteProp<
		{ params: { generalDetails: any, location: Location.LocationObject } },
		'params'
	>,
	navigation: any,
};
...
const FacilitiesSchema = Yup.object().shape({
	...
	numberOfRooms: Yup.mixed()
		.oneOf(Object.values(NumberOfBedroomsEnum))
		.required('Number of rooms is required'),
	numberOfBathrooms: Yup.mixed()
		.oneOf(Object.values(NumberOfBedroomsEnum))
		.required('Number of bathrooms is required'),
	amenities: Yup.array().of(
		Yup.string().oneOf(Object.values(RentalAmenitiesEnum)),
	),
...
export const ListingFacilitiesScreen: React.FC<ListingFacilitiesScreenPops> = ({
	route,
	navigation,
}) => {
						...
						<View>
							...
							<CustomSwitchSelector
								options={[
									{
										label: '1',
										value: NumberOfBedroomsEnum.One,
									},
									{
										label: '2',
										value: NumberOfBedroomsEnum.Two,
									},
									{
										label: '3',
										value: NumberOfBedroomsEnum.Three,
									},
									{
										label: '+4',
										value: NumberOfBedroomsEnum.FourOrMore,
									},
								]}
								initial={1}
								onPress={(value) =>
									setFieldValue('numberOfRooms', value)
								}
								mode={'green'}
							/>
							...
							<CustomSwitchSelector
								options={[
									...
									{
										label: '+3',
										value: NumberOfBathroomsEnum.ThreeOrMore,
									},
								]}
								initial={1}
								onPress={(value) =>
							...
							<KeyboardAwareScrollView style={{ height: 270 }}>
								{Object.values(RentalAmenitiesEnum).map(
									(amenity) => (
										<View
											key={amenity}
