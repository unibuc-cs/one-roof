						...
						>
							{({ setFieldValue, handleChange, handleBlur, handleSubmit, values, errors }) => (
								<View style={styles.container}>
									...
									<HeaderText textAlign={'left'} size={15}>Short context regarding your living situation:</HeaderText>
									<TextInputSmaller
										marginVertical={0}
									...
									<HeaderText textAlign={'left'} size={15}>On a scale from 1 to 5, would you recommend your living situation to a friend?</HeaderText>
									<TextInputSmaller
										marginVertical={0}
									...
									<HeaderText textAlign={'left'} size={15}>What would you have liked to know before moving in here? What do you enjoy most about this place? What are the gotchas?</HeaderText>
									<TextInputSmaller
										marginVertical={0}
										numberOfLines={4}
